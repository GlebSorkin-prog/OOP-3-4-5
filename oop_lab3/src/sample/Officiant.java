...
public class Officiant extends WorkingEmployee {

    private double coefficient=1.8;
    private String department="officiant";

    public Officiant(String name, String surname, int age, int number, double skill) {
